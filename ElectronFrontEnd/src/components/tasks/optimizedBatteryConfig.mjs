...
const SPEECH_BASE_FORMS = [
  ...
  },
  {
    ...
    // Trimmed to its first 8 sentences (was 10); see tools/README.md.
  ...
  },
  {
    ...
    // Trimmed to its first 9 sentences (was 12); see tools/README.md.
