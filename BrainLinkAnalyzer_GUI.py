...
def detect_brainlink():
    ...
    if platform.system() == 'Windows':
        BRAINLINK_SERIALS = ("5C361634682F", "5C3616327E59", "5C3616346938", "5C3616346838", "5C36163468D3", "5C3616327C21", "5C36163468D3", "90E2FC2C5F37", "90E2FC2C627C", "90E2FC2C6378","90E2FC2C5E7D","90E2FC2C5FAA","90E3FC2C614B")
        for port in ports:
            if hasattr(port, 'hwid'):
